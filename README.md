...
#### 1. [Download exe](https://github.com/yuk7/WSL-DistroLauncher/releases/latest) (There are lots of exe files. _Launcher.exe has no icon. Other exe files each have a different icon.)
